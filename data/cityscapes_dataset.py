...
class Cityscapes_loader(BaseDataset):
    ...
    def __init__(self, opt, logger, augmentations = None, split='train', domain_id=0):
        ...
        # self.files = list(zip(*sorted_paths))
    ...
    def map_labels(self, input_):
        return self.class_map[input_.astype(np.uint8, copy=False)]
    ...
    def __getitem__(self, index):
        ...
        if self.opt.src_dataset != 'cityscapes' and self.split == 'train' and self.opt.used_save_pseudo:
